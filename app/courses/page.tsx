    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-red-700 to-red-600 py-16">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-red-100 mb-6">Industry-Relevant Computer Education Programs</p>
      ...
      <section className="py-8 bg-gray-50 border-b">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-wrap gap-4 items-center">
            ...
            <button className="px-4 py-2 bg-red-600 text-white rounded-md text-sm font-medium">All Courses</button>
            <button className="px-4 py-2 bg-white text-gray-700 rounded-md text-sm font-medium hover:bg-red-50 transition-colors">Beginner</button>
            <button className="px-4 py-2 bg-white text-gray-700 rounded-md text-sm font-medium hover:bg-red-50 transition-colors">Intermediate</button>
            <button className="px-4 py-2 bg-white text-gray-700 rounded-md text-sm font-medium hover:bg-red-50 transition-colors">Advanced</button>
            <button className="px-4 py-2 bg-white text-gray-700 rounded-md text-sm font-medium hover:bg-red-50 transition-colors">Diploma</button>
          </div>
        </div>
      </section>
              ...
              <div key={course.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow border border-gray-100">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t">
                    ...
                    <button className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md text-sm font-medium flex items-center gap-2 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md text-center">
              ...
              <h3 className="font-bold text-gray-800 mb-2">Updated Curriculum</h3>
              <p className="text-sm text-gray-600">Industry-aligned course content</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-md text-center">
              <Award className="w-12 h-12 text-green-600 mx-auto mb-4" />
              <h3 className="font-bold text-gray-800 mb-2">Certification</h3>
              <p className="text-sm text-gray-600">Government recognized certificates</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-md text-center">
              <Users className="w-12 h-12 text-yellow-600 mx-auto mb-4" />
              <h3 className="font-bold text-gray-800 mb-2">Placement Support</h3>
              <p className="text-sm text-gray-600">Career guidance and job assistance</p>
            </div>
          </div>
        </div>
      </section>
